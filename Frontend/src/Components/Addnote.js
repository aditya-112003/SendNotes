    ...
    return (
        <div className='my-3 container'>
            ...
            <form className='my-2'>
                ...
                <button disabled={note.title.length<5 || note.description.length<5 } type="submit" className="btn btn-primary" onClick={handleClick}><i class="fa-solid fa-plus"></i> Add a Note</button>
            </form>
        </div>
    )
}
